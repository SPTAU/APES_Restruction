...
train_dataloader = dict(batch_size=64,  # batch size per GPU
                        ...
                        pin_memory=True,
                        drop_last=True,
                        dataset=dict(type='ModelNet_Res',
                                     ...
                                     pipeline=[dict(type='LoadPCD'),
                                               ...
                                               dict(type='ToRESTensor'),
                                               dict(type='PackRESInputs')]),
...
# evaluators
val_evaluator = dict(type='ChamferDistance', mode='val')
test_evaluator = dict(type='ChamferDistance', mode='test')
